...
- 相続・成年後見・死後事務は誤情報リスクが高い。AI下書きは必ず要確認表示、人間承認なしに published にしない（例外: カテゴリ「ニュース」のみ月次自動公開。docs/monthly-news-auto.md）（例外: カテゴリ「ニュース」のみ月次自動公開。docs/monthly-news-auto.md）
